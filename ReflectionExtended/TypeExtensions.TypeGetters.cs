...
namespace ReflectionExtended
{
    public static partial class TypeExtensions
    {
        ...
        public static IEnumerable<Type> GetDerivedTypes(this Type self, params Assembly[] assemblies) =>
        self.GetDerivedTypes( (IEnumerable<Assembly>) assemblies );

        public static IEnumerable<Type> GetExportedDerivedTypes(this Type self, params Assembly[] assemblies) =>
        self.GetDerivedTypes( assemblies, true );

        public static IEnumerable<Type>
        GetDerivedTypes(this Type self, AppDomain appDomain, bool onlyExported = false) => appDomain.GetAssemblies()
